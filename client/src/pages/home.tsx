          ...
          <div className="relative z-10 h-screen flex flex-col justify-center px-3 sm:px-4 lg:px-6 py-4 sm:py-8 lg:py-12">
            ...
            <div className="text-center max-w-6xl mx-auto w-full">
              ...
              <div className="hero-text-reveal hero-text-reveal-delay-3 mb-6 sm:mb-8 lg:mb-10">
                <div className="max-w-5xl mx-auto p-3 sm:p-4 lg:p-6 border rounded-xl backdrop-blur-sm" style={{backgroundColor: 'rgba(76, 134, 107, 0.45)', borderColor: 'rgba(76, 134, 107, 0.7)'}}>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 sm:gap-2.5 w-full">
                    <div className="text-center">
                      <div className="text-[0.65rem] sm:text-xs lg:text-sm font-bold mb-1 leading-tight" style={{color: 'rgba(186, 130, 46, 1)'}}>R25,000+ Bronze Artwork</div>
                    ...
                    <div className="text-center">
                      <div className="text-[0.65rem] sm:text-xs lg:text-sm font-bold mb-1 leading-tight" style={{color: 'rgba(186, 130, 46, 1)'}}>50–80% Off Your First Workshop — Giftable</div>
                    ...
                    <div className="text-center">
                      <div className="text-[0.65rem] sm:text-xs lg:text-sm font-bold mb-1 leading-tight" style={{color: 'rgba(186, 130, 46, 1)'}}>Lifetime Discounts — For You & Anyone You Gift</div>
                    ...
                    <div className="text-center">
                      <div className="text-[0.65rem] sm:text-xs lg:text-sm font-bold mb-1 leading-tight" style={{color: 'rgba(186, 130, 46, 1)'}}>Open-Shed Access</div>
                    ...
                    <div className="text-center">
                      <div className="text-[0.65rem] sm:text-xs lg:text-sm font-bold mb-1 leading-tight" style={{color: 'rgba(186, 130, 46, 1)'}}>Your Name on the Founding 100 Wall</div>
